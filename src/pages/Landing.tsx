  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-card to-background">
      ...
      <div className="p-6 text-center pt-16">
        ...
        <p className="text-muted-foreground">Platform freelancing sosial Indonesia</p>
      </div>
        ...
        <div className="space-y-4">
          <div className="bg-card border border-card-border rounded-2xl p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-foreground mb-1">Temukan Freelancer</h3>
          ...
          <div className="bg-card border border-card-border rounded-2xl p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-foreground mb-1">Tawarkan Jasa</h3>
                <p className="text-sm text-muted-foreground">
          ...
          <div className="bg-card border border-card-border rounded-2xl p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-foreground mb-1">Transaksi Aman</h3>
                <p className="text-sm text-muted-foreground">
        ...
        <div className="bg-gradient-to-br from-primary to-primary/80 rounded-2xl p-8 text-center">
          <div className="space-y-4">
            ...
            <p className="text-primary-foreground/90">
              Bergabung dengan ribuan freelancer dan employer di seluruh Indonesia
            </p>
          </div>
        </div>
      </div>
